...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DoxnJe8a.mjs");
...
const manifest = {
  "625708959784a3e3bb62af17d4624bfdeefb749934b9540e3fca167595540c54": {
    functionName: "sendSupportEmail_createServerFn_handler",
    importer: () => import("./support.functions-YnVk4F_L.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-_tRA0p-q.mjs").then((n) => n.router),
    import("./start-BSAjFOoH.mjs"),
